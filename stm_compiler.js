        ...
        switch (block.type) {
            ...
            case 'disp_text': {
                ...
                for (let i = 0; i < txt.length && i < 32; i++)
                    bytes.push(txt.charCodeAt(i) & 0x7F);
                // DISP_TEXT x y big len chars...
                this.emit(OP.DISP_TEXT, x, y, big, bytes.length, ...bytes);
                break;
            }
            ...
            case 'disp_number': {
                ...
                this.emit(OP.DISP_NUMBER, x, y);
                break;
            }

            case 'disp_pixel':    /* статичний піксель (static X,Y у bytecode) */
                this.emit(OP.DISP_PIXEL, this.compileValue(block,'X'), this.compileValue(block,'Y'));
                break;
            ...
            case 'disp_line': {
                ...
                this.emit(OP.DISP_LINE, x1, y1, x2, y2);
                break;
            }
